import {
  Dialog
} from "./chunk-KFQM2JVT.js";
import {
  Button
} from "./chunk-6KCVO75S.js";
import "./chunk-NE3TIO2L.js";
...
import {
  ...
  trigger,
  useAnimation
} from "./chunk-QF52E4L4.js";
import "./chunk-K25FJA5P.js";
import {
  BaseComponent
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function ConfirmDialog_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        ɵɵproperty("closable", ctx.option("closable"))("styleClass", ctx.containerClass)("modal", true)("header", ctx.option("header"))("closeOnEscape", ctx.option("closeOnEscape"))("blockScroll", ctx.option("blockScroll"))("appendTo", ctx.option("appendTo"))("position", ctx.position)("dismissableMask", ctx.dismissableMask);
        ɵɵadvance(2);
